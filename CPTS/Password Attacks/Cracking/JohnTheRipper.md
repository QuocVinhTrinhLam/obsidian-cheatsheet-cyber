...
```shell
3kjS@htb[/htb]$ john --single passwd
```
#### Wordlist mode

```shell
3kjS@htb[/htb]$ john --wordlist=<wordlist_file> <hash_file>
```
#### Incremental mode

```shell
3kjS@htb[/htb]$ john --incremental <hash_file>
```
## Identifying hash formats

```shell
3kjS@htb[/htb]$ hashid -j 193069ceb0461e1d40d216e32c79c704
```
...
```shell
3kjS@htb[/htb]$ <tool> <file_to_crack> > file.hash
```
